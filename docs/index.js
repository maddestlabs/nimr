...
var ASM_CONSTS = {
  90976: () => { if (document.fullscreenElement) return 1; },  
 91022: () => { return Module.canvas.width; },  
 91054: () => { return parseInt(Module.canvas.style.width); },  
 91102: () => { document.exitFullscreen(); },  
 91129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 91202: () => { if (document.fullscreenElement) return 1; },  
 91248: () => { return Module.canvas.width; },  
 91280: () => { return screen.width; },  
 91305: () => { document.exitFullscreen(); },  
 91332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 91465: () => { return window.innerWidth; },  
 91491: () => { return window.innerHeight; },  
 91518: () => { if (document.fullscreenElement) return 1; },  
 91564: () => { return Module.canvas.width; },  
 91596: () => { return parseInt(Module.canvas.style.width); },  
 91644: () => { if (document.fullscreenElement) return 1; },  
 91690: () => { return Module.canvas.width; },  
 91722: () => { return screen.width; },  
 91747: () => { return window.innerWidth; },  
 91773: () => { return window.innerHeight; },  
 91800: () => { if (document.fullscreenElement) return 1; },  
 91846: () => { return Module.canvas.width; },  
 91878: () => { return screen.width; },  
 91903: () => { document.exitFullscreen(); },  
 91930: () => { if (document.fullscreenElement) return 1; },  
 91976: () => { return Module.canvas.width; },  
 92008: () => { return parseInt(Module.canvas.style.width); },  
 92056: () => { document.exitFullscreen(); },  
 92083: ($0) => { Module.canvas.style.opacity = $0; },  
 92121: () => { return screen.width; },  
 92146: () => { return screen.height; },  
 92172: () => { return window.screenX; },  
 92199: () => { return window.screenY; },  
 92226: () => { return window.devicePixelRatio; },  
 92262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 92315: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92366: () => { Module.canvas.style.cursor = 'none'; },  
 92403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 92659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92710: () => { if (document.pointerLockElement) return 1; },  
 92757: () => { if (document.fullscreenElement) return 1; },  
